  ...
  return (
    <div className="mx-auto max-w-3xl" style={{ animation: "fade-up 0.3s ease" }}>
      <div className="mb-3 flex items-center gap-3">
        ...
        <CopyButton
          className="ml-auto"
          text={newJigPrompt({ origin: window.location.origin })}
          label="Copy new-jig prompt"
      ...
      <div className="space-y-0.5">
        ...
        {filteredJigs.length === 0 && (
          <EmptyState
            ...
            description={jigSearch ? "Try a different search or filter." : "Change the filter, or copy the new-jig prompt above for your coding agent."}
          />
        )}
      </div>
    </div>
