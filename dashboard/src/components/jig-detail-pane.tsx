  ...
  const runSteps: RunStep[] = useMemo(() => {
    ...
    if (mode.type === "done") {
      ...
      return derived.map((s, i) => ({
        ...
        time: i === 0 ? `${mode.elapsed}s` : undefined,
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              disabled={isRunning}
              className="rounded-md bg-emerald-600 px-2.5 py-1 text-[10px] font-medium text-white transition-all duration-150 hover:bg-emerald-500 active:scale-95 disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={isRunning}
              className="rounded-md border border-emerald-600/30 bg-emerald-600/10 px-2.5 py-1 text-[10px] font-medium text-emerald-400 transition-all duration-150 hover:bg-emerald-600/20 active:scale-95 disabled:opacity-50"
