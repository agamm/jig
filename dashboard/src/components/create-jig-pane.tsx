    ...
    >
      ...
      <div className="flex h-11 shrink-0 items-center justify-between border-b border-[#1f1f23] px-4 gap-3">
        <div className="flex items-center gap-2 min-w-0 flex-1">
          <h2
            key={displayName}
            className="text-[14px] font-semibold text-[#ededed] whitespace-nowrap"
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-5">
        <div className="flex items-center justify-between">
          <div className="flex gap-0.5 rounded-lg border border-[#1f1f23] bg-[#0a0a0b] p-0.5 w-fit">
            <button className="rounded-md bg-[#1a1a1d] px-3 py-1 text-[11px] font-medium text-[#ededed]">Steps</button>
            <button className="rounded-md px-3 py-1 text-[11px] font-medium text-[#555]">Code</button>
          </div>
