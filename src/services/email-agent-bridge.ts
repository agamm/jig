 ...
 *
 * Auto-approve is the policy: an authenticated owner reply ships the edit with
 * no dashboard step (see email-inbound.ts for the auth gate). The owner asked
 * for this change in their own words, so the reply is the approval.
 */
import { publicUrl } from "../config/runtime.js"
import { setEmailThreadSession } from "../db.js"
import { autoApproveSession, getAgentSessionStatus, subscribeToSessionFrames } from "./agent-service.js"
